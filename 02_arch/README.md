...
После окончания курса вам достаточно часто придётся ориентироваться на примеры, которые выкладываются самим Google, демонстрирующим использование той или иной библиотеки (в том числе из Jetpack).
